            ...
            .addOnSuccessListener {
                it.documents.let {
                    if (it.isEmpty()) { // Add new product
                        ...
                        if (product != null) {
                            if (product.product == cartProduct.product && product.selectedColor == cartProduct.selectedColor && product.selectedSize == cartProduct.selectedSize) { // Increase the quantity
